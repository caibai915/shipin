    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            ...
            <li class="disabled"><a href="#" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
                ...
                <c:if test="${queryVo.page>1 && page.page<=countSize }">
                <a href="${pageContext.request.contextPath}/speaker/showSpeakerList?page=${queryVo.page-1}" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                </a>
                </c:if>

                <c:forEach begin="1" end="" varStatus="i">
                <c:if test="${page.page==i.count}">
            <li class="active"><a href="#" >${i.count}</a>
                </c:if>
                <c:if test="${page.page!=i.count}">
            <li><a href="${pageContext.request.contextPath}/speaker/showSpeakerList?page=${i.count}" >${i.count}</a>
                </c:if>
                </c:forEach>
            <li>

                <c:if test="${page.page>=countSize}">
            <li class="disabled"><a href="#" aria-label="Next">
                <span aria-hidden="true">&raquo;</span></a>
                </c:if>
                <c:if test="${page.page<countSize && queryVo.page>=1}">
                <a href="${pageContext.request.contextPath}/speaker/showSpeakerList?page=${queryVo.page+1}" aria-label="Next">
