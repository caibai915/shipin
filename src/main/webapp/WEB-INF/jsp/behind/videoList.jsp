        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <li class="disabled"><a href="#" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
                    ...
                    <a href="${pageContext.request.contextPath}/video/list?page=${queryVo.page-1}" aria-label="Previous">
                ...
                <li class="active"><a href="#" >${i.count}</a>
                    ...
                    <c:if test="${page.page!=i.count}">
                <li><a href="${pageContext.request.contextPath}/video/list?page=${i.count}" >${i.count}</a>
                    </c:if>
                    </c:forEach>
                <li>
                ...
                <li class="disabled"><a href="#" aria-label="Next">
                    ...
                    <a href="${pageContext.request.contextPath}/video/list?page=${queryVo.page+1}" aria-label="Next">
