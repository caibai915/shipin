...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            //div 两个哪个显示呢？
            if (null != "${sessionScope.user}" && "${sessionScope.user}" != "") {
            ...
            <div class="v-intro">
                ...
                <div class="right">
                    ...
                    <div class="avatar">
                        ...
                        <p><b>讲师：${video.speaker.speakerName}</b><br>
        ...
        <div class="container">
            ...
            <c:forEach items="${course.videoList}" var="video">
                <div class="chapter" onclick="load(${video.id})">
                    <p class="biaoti"><a
                            href="${pageContext.request.contextPath}/video/showVideo?videoId=${video.id}&subjectName=${subjectName}">${video.title}</a></p>
