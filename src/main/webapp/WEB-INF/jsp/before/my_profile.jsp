            ...
            <div id="user_bar">
                <a href="user/showMyProfile">
                    ...
                    <c:if test="${not empty sessionScope.user.imgUrl}">
                        <img id="avatar" src="http://localhost:8083/video/${sessionScope.user.imgUrl}" alt="">
                    </c:if>
            ...
            <div class="proflle_tab_body">
                ...
                <div class="proflle_tab_workplace clearfix">
                    <div class="profile_avatar_area">
                        ...
                        <c:if test="${not empty sessionScope.user.imgUrl}">
                            <img id="avatar" width="180px" heigth="180px" src="http://localhost:8089/img/${sessionScope.user.imgUrl}" alt="">
                        </c:if>
                        <p>
